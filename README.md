...
Following is just enough information to get starter. Windows-friendly edits are welcome. Browsertrix is pretty simple to use so hopefully the scripts are fairly self-explanatory.
